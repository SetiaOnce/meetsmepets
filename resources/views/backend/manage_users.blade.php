@extends('backend.layouts', ['activeMenu' => 'USERS', 'activeSubMenu' => ''])
@section('content')
<!--begin::Card Form-->
                ...
                <div class="col-md-12">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group input-group-solid mb-2">
                            ...
                            <input type="text" class="form-control form-control-lg form-control-solid no-space" name="phone_number" id="phone_number" placeholder="Isikan No. Telpon/Hp user ..." />
                        </div>
