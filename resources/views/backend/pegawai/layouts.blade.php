...
<head>
    ...
    @include('backend.pegawai.partials.styles')
</head>
<!--end::Head-->
<!--begin::Body-->
<body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true"
	...
	<div class="d-flex flex-column flex-root app-root" id="kt_app_root">
		...
		<div class="app-page flex-column flex-column-fluid" id="kt_app_page">
            @include('backend.pegawai.partials.header')
			<!--begin::Wrapper-->
			<div class="app-wrapper flex-column flex-row-fluid " id="kt_app_wrapper">
				@include('backend.pegawai.partials.sidebar')
				<!--begin::Main-->
				<div class="app-main flex-column flex-row-fluid " id="kt_app_main">
					...
					<!--end::Content wrapper-->
					@include('backend.pegawai.partials.footer')
				</div>
				<!--end:::Main-->
			</div>
			<!--end::Wrapper-->
	...
	<!--end::App-->
    @include('backend.pegawai.partials.engage')
    @include('backend.pegawai.partials.scripts')
</body>
<!--end::Body-->
</html>