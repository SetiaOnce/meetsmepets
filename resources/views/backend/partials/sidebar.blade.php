        ...
        <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper">
            <div id="kt_app_sidebar_menu_scroll"
                ...
                <div class="menu menu-column menu-rounded menu-sub-indention fw-semibold fs-6"
                    ...
                    <!--begin:Menu item-->
                    <div class="menu-item">
                        <a class="menu-link {{ strtolower($activeMenu) == strtolower('DASHBOARD') ? 'active' : '' }}" href="{{ url('app_admin') }}">
                    ...
                    <!--begin:Menu item-->
                    <div class="menu-item">
                        <a class="menu-link {{ strtolower($activeMenu) == strtolower('WEBSITE_INFORMATION') ? 'active' : '' }}" href="{{ url('/site_information') }}">
                            <span class="menu-icon">
                                <i class="bi bi-gear fs-1"></i>
                            </span>
                            <span class="menu-title">SITE INFORMATION</span>
                        </a>
                    </div>
                    <!--begin:Menu item-->
                    <!--begin:Menu item-->
                    <div class="menu-item">
                        <a class="menu-link {{ strtolower($activeMenu) == strtolower('USERS') ? 'active' : '' }}" href="{{ url('/app_admin/manage_users') }}">
                            <span class="menu-icon">
                    ...
                    <!--begin:Menu item-->
                    <!--begin:Menu item-->
                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion  {{ strtolower($activeSubMenu) == 'master' ? 'show' : '' }}">
                        <!--begin:Menu link-->
                        ...
                        <div class="menu-sub menu-sub-accordion ">
                            ...
                            <div class="menu-item">
                                <!--begin:Menu link-->
                                <a href="{{ url('master/category') }}" class="menu-link {{ strtolower($activeMenu) == 'master_category' ? 'active' : '' }}">
                            ...
                            <div class="menu-item">
                                <!--begin:Menu link-->
                                <a href="{{ url('master/interest') }}" class="menu-link {{ strtolower($activeMenu) == 'master_interest' ? 'active' : '' }}">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
