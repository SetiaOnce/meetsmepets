...
<div class="card mb-5 mb-xl-10" id="cardUserInfo">
    ...
    <div class="card-body" id="editUserInfo" style="display: none;">
        <div class="d-flex justify-content-between align-items-start flex-wrap">
            ...
            <a href="javascript:void(0);" class="btn btn-sm btn-bg-light btn-color-danger ms-3" onclick="_closeContentCard('edit-userProfile')"><i class="las la-undo fs-3"></i> Kembali</a>
        </div>
        <!--begin::Form-->
        <form id="form-editProfile" class="form" onsubmit="return false">
            ...
            <div class="row mb-6">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="form-text">*) Pastikan email sesuai format dan masih aktif digunakan, contoh: <code>rezareff123@gmail.com</code></div>
                </div>
            </div>
            <!--end::Input group-->
            <!--begin::Input group-->
