@extends('backend.admin.layouts', ['activeMenu' => 'PEGAWAI_PERKANTOR', 'activeSubMenu' => 'sik'])
@section('content')
...
<div class="card shadow" id="card-data">
    ...
    <div class="card-header">
        <div class="card-title">
            <h3 class="fw-bolder fs-2 text-gray-900">
                <i class="fas fa-th-list fs-2 text-gray-900 me-2"></i> List Data Pegawai PerKantor
            </h3>
        </div>
    ...
    <div class="card-body">
        <div class="table-responsive">
            <!--begin::Table-->
            <table class="table table-rounded  table-hover align-middle table-row-bordered border" id="dt-pegawaiPerKantor">
                <thead>
                    <tr class="fw-bolder text-uppercase bg-light fs-8">
                        ...
                        <th class="border-bottom-2 border-gray-200 align-middle px-2">Pangkat</th>
                    </tr>
                </thead>
