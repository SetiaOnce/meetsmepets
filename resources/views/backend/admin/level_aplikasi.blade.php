@extends('backend.admin.layouts', ['activeMenu' => 'LEVEL_APLIKASI', 'activeSubMenu' => 'management'])
@section('content')
<!--begin::Card Form-->
    ...
    <div class="card-header">
        ...
        <div class="card-toolbar">
            <div class="d-flex justify-content-end">
                <button type="button" class="btn btn-sm btn btn-bg-light btn-color-danger btn-active-light-danger" id="btn-closeForm" onclick="_closeCard('form_level_aplikasi');"><i class="fas fa-times fs-3 me-1"></i>Tutup</button>
            </div>
        </div>
    </div>
    <!--end::Card header-->
            ...
            <div class="row d-flex justify-content-between">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group mb-3">
                        <label class="col-form-label required fw-bold fs-6" for="nama_level">Nama Level</label>
                        <input type="text" name="nama_level" id="nama_level" class="form-control mb-lg-0" maxlength="120" placeholder="Isikan nama level ..." />
...
<div class="card shadow" id="card-data">
    ...
    <div class="card-header">
        <div class="card-title">
            <h3 class="fw-bolder fs-2 text-gray-900">
                <i class="fas fa-th-list fs-2 text-gray-900 me-2"></i> List Level Aplikasi
            </h3>
        </div>
        <div class="card-toolbar">
            <div class="d-flex justify-content-end">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <!--begin::Table-->
            <table class="table table-rounded  table-hover align-middle table-row-bordered border" id="dt-levelAplikasi">
                <thead>
                    <tr class="fw-bolder text-uppercase bg-light fs-8">
                        ...
                        <th class="border-bottom-2 border-gray-200 align-middle px-2">Nama Level</th>
