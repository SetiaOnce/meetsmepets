@extends('backend.admin.layouts', ['activeMenu' => 'PENGELOLA_PORTAL', 'activeSubMenu' => ''])
@section('content')
<!--begin::Card Form-->
            ...
            <div class="row justify-content-start">
                <div class="col-md-8">
                    ...
                    <div class="mb-3" id="iGroup-fid_pegawai">
                        ...
                        <select class="show-tick form-select-solid" data-width="100%" data-style="btn-secondary text-dark" name="fid_pegawai" id="fid_pegawai" data-container="body" data-live-search="true" title="Pilih Pegawai ..."></select>
                    </div>
                    <!--end::Input group-->
                </div>
...
<div class="card shadow" id="card-data">
    ...
    <div class="card-header">
        <div class="card-title">
            <h3 class="fw-bolder fs-2 text-gray-900">
                <i class="fas fa-th-list fs-2 text-gray-900 me-2"></i> List User Pengelola Portal
            </h3>
        </div>
        <div class="card-toolbar">
            <div class="d-flex justify-content-end">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <!--begin::Table-->
            <table class="table table-rounded  table-hover align-middle table-row-bordered border" id="dt-pengelola">
                <thead>
