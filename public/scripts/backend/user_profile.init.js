...
const _loadUserOnProfile = () => {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            let urlThumbUser = data.row.thumb_url;
                    ...
                    <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <div class="d-flex align-items-center mb-2">
                                ...
                                ` +statusUser+ `
                                <span class="badge badge-light-success fw-bold ms-2 fs-8 py-1 px-3">ADMINISTRATOR</span>
                            </div>
                            <!--end::Name-->
                        </div>
                        <!--end::User-->
...
const _editMyProfile = () => {
    ...
    _loadFotoUser(dataUserSes.thumb, dataUserSes.thumb_url);
