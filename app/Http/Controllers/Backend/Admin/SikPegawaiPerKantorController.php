...
class SikPegawaiPerKantorController extends Controller
{
    public function index()
    {
        ...
        $data['js'] = array(
            ...
            'scripts/backend/admin/sik_pegawai_perkantor.js'
        );
        Shortcut::logActivities('Mengakses Halaman Pegawai Per-Kantor SIK');
        return view('backend.admin.sik_pegawai_perkantor', compact('data'));
    }
    public function data(Request $request)
    {
        $data = json_decode(SoapSik::whereId(1)->first()->pegawai_perkantor);
    ...
    public function sincronize()
    {
        try{  
            ...
            Shortcut::logActivities('Melakukan Sinkronisasi Data Pegawai ASN');
